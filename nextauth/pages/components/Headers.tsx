...
const Headers = () => {
  ...
  return (
      ...
      <div className="container flex flex-wrap items-center justify-between mx-auto">
        ...
        { status==="authenticated"? <Link
         ...
         { status!=="authenticated"?   <Link
          ...
          >
            Sign IN
          </Link> : <p className="text-white bg-teal-500 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0"
          >{session.user.name}</p>
        }
        </div>
    ...
    <ul className="flex flex-col p-4 mt-4 border  rounded-lg  md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 ">
      <li>
        <a href="#" className="block py-2 pl-3 pr-4  hover:text-green-300 text-white rounded md:bg-transparent md:p-0" aria-current="page">List</a>
      </li>
      <li>
        <a href="#" className="block py-2 pl-3 pr-4  hover:text-green-300 text-white rounded md:bg-transparent md:p-0" aria-current="page">Create</a>
      </li>
      <li>
